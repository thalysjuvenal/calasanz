...
<body>
	<?php if ($cabecalho_rel_img != 'Sim') { ?>
		<section class="area-cab">
			<div class="cabecalho">
				<div class="coluna titulo_cab" style="width:50%"> <u>
						<?php echo $titulo_rel ?>
					</u></div>
				<div align="right" class="coluna" style="width:50%"> <img style="margin-top:5px"
						src="<?php echo $url_sistema ?>img/igrejas/<?php echo $imagem_igreja ?>" width="30px">
		...
		<section class="area-cab">
			<div class="cabecalho">
				<div class="coluna" style="width:60%"><small> <small><small>
	...
	<?php } else { ?>
		<div class="titulo_cab titulo_img"><u>
				<?php echo $titulo_rel ?>
			</u></div>
		<div class="data_img"><small> <small><small>
						<?php echo mb_strtoupper($data_hoje) ?>
					</small></small></small></div>
	...
	<div class="mx-2" style="padding-top:10px ">
		<section class="area-cab">
			<div class="coluna" style="width:50%">
				<small><small><small><u>
								<?php echo $texto_apuracao ?>
							</u></small></small></small>
			</div>
			<div class="coluna" style="width:50%" align="right">
				<small><small><small>
							<span class="mx-4"><img src="<?php echo $url_sistema ?>img/verde.jpg" width="8px"
									style="margin-top:6px"> Entradas </span>
							<span class="mx-4"><img src="<?php echo $url_sistema ?>img/vermelho.jpg" width="8px"
									style="margin-top:6px"> Saídas </span>
						</small></small></small>
			</div>
		</section>
		<br>
						...
						<section class="area-tab" style="padding-top:5px">
							<div class="linha-cab">
								<div class="coluna" style="width:20%">
									<span class=""><img src="<?php echo $url_sistema ?>img/<?php echo $classe_item ?>"
											width="9px" style="margin-top:4px"> </span>
									<?php echo $res[$i]['movimento'] ?>
								</div>
								<div class="coluna" style="width:30%">
									<?php echo $res[$i]['descricao'] ?>
								</div>
								<div class="coluna <?php echo $classe_valor ?>" style="width:15%">R$
	...
	<?php if ($movimento != "%%") { ?>
		<div class="col-md-12 p-2">
			<div class="" align="right">
				<small><small>TOTAL R$ <span class="<?php echo $classe_total ?>">
	...
	<?php } else { ?>
		<div class="col-md-12 p-2">
			<div class="" align="right">
				<span class="mx-4"><small><small>ENTRADAS R$ <span class="text-success">
								<?php echo number_format(@$entradas, 2, ',', '.'); ?>
							</span></small></small> </span> /

				<span class="mx-4"><small><small>SAÍDAS R$ <span class="text-danger">
								<?php echo number_format(@$saidas, 2, ',', '.'); ?>
							</span></small></small> </span>

				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

				<span class="mx-4"><small><small>SALDO R$ <span class="<?php echo $classe_saldo ?>">
	...
	<div class="footer" align="center">
		<span style="font-size:10px">
			<?php echo $end_igreja ?> - Telefone:
			<?php echo $tel_igreja ?> - Contador Responsável:
