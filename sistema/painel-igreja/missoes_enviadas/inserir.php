...
$pdo->query("INSERT INTO movimentacoes SET tipo = 'Saída', movimento = 'Missões Enviadas', descricao = '$membro', valor = '$valor', data = '$data', usuario = '$id_usuario', id_mov = '$ult_id', igreja = '$igreja'");
	...
	//INSIRO NAS MOVIMENTACOES
$pdo->query("UPDATE movimentacoes SET descricao = '$membro', valor = '$valor', data = '$data', usuario = '$id_usuario' where id_mov = '$id' and movimento = 'Missões Enviadas'");
