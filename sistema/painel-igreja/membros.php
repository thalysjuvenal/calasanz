				...
				for ($i = 0; $i < $total_reg; $i++) {
					...
					<tr class="<?php echo $inativa ?>">
						...
						<td>
							<big>
								<a href="#"
									onclick="editar('<?php echo $id ?>', '<?php echo $nome ?>', '<?php echo $cpf ?>', '<?php echo $email ?>', '<?php echo $telefone ?>', '<?php echo $endereco ?>', '<?php echo $foto ?>', '<?php echo $data_nasc ?>', '<?php echo $igreja ?>', '<?php echo $nome_ig ?>', '<?php echo $data_bat ?>', '<?php echo $cargo ?>', '<?php echo $estado ?>', '<?php echo $rg ?>', '<?php echo $nome_pai ?>', '<?php echo $nome_mae ?>', '<?php echo $naturalidade ?>', '<?php echo $nacionalidade ?>', '<?php echo $membresia ?>')"
								...
								<a href="#"
									onclick="dados('<?php echo $nome ?>', '<?php echo $cpf ?>', '<?php echo $email ?>', '<?php echo $telefone ?>', '<?php echo $endereco ?>', '<?php echo $foto ?>', '<?php echo $data_nascF ?>', '<?php echo $data_cadF ?>', '<?php echo $nome_ig ?>', '<?php echo $data_batF ?>', '<?php echo $nome_cargo ?>', '<?php echo $estado ?>', '<?php echo $rg ?>', '<?php echo $nome_pai ?>', '<?php echo $nome_mae ?>', '<?php echo $naturalidade ?>', '<?php echo $nacionalidade ?>', '<?php echo $membresiaF ?>')"
									title="Ver Dados"> <i class="bi bi-info-square-fill text-primary"></i> </a>

								<a href="#" onclick="obs('<?php echo $id ?>','<?php echo $nome ?>', '<?php echo $obs ?>')"
									title="Observações"> <i class="bi bi-chat-right-text <?php echo $classe_obs ?>"></i> </a>


								<a href="#" onclick="mudarStatus('<?php echo $id ?>', '<?php echo $ativar ?>')"
									title="<?php echo $ativo ?>">
								...
								<a href="#" onclick="modalApresentacao('<?php echo $id ?>', '<?php echo $nome ?>')"
									title="Certificado de Apresentação">
									<i class="bi bi-bookmark-star text-secondary"></i></a>

								<a href="#" onclick="transferir('<?php echo $id ?>', '<?php echo $nome ?>')"
...
<div class="modal fade" id="modalTransf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><span id="tituloModal">Carta de Recomendaçao - <span
							id="nome-transf"></span></span></h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form id="form-obs" method="post" action="../rel/relRecomendacao.php" target="_blank">
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<input class="form-control" id="igreja-transf" name="igreja"
							placeholder="Nome da Igreja à Recomendar">
					</div>

					<div class="mb-3">
						<label for="exampleFormControlInput1" class="form-label">Observações (Máximo 2000
							Caracteres)</label>
						<textarea class="form-control" id="obs-transf" name="obs" maxlength="2000"
							style="height:200px"></textarea>
					</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
						id="btn-fechar-transf">Fechar</button>
...
<div class="modal fade" id="modalApresentacao" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<span class="modal-title" id="exampleModalLabel"><span id="tituloModal">Certificado de Apresentação -
						<span id="nome-apres"></span></span></span>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			...
			<div class="modal-body">
				...
				<small>
					<div id="mensagem-apres" align="center"></div>
				</small>
...
<div class="modal fade" id="modalTransferir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<span class="modal-title" id="exampleModalLabel"><span id="tituloModal">Transferir Membro - <span
							id="nome-transferir"></span></span></span>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<form id="form-transferir" method="post" action="../rel/relRecomendacao.php" target="_blank">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<select class="form-control sel3" id="igreja-membro" name="igreja" style="width:100%;"
								required>
								<?php
					...
					<small>
						<div id="mensagem-transferir" align="center"></div>
					</small>

					<input type="hidden" class="form-control" name="id" id="id-transferir">
					<input type="hidden" class="form-control" name="igreja_saida" id="igreja_saida"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
						id="btn-fechar-transferir">Fechar</button>
