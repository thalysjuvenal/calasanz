			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					<tr>
						...
						<td class="esc"><?php echo $membro ?></td>
		...
		<div class="modal-content">
			...
			<form id="form" method="post">
				<div class="modal-body">
					...
					<div class="col-md-12">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Ofertado para </label>
								<input type="text"  class="form-control" id="membro" name="membro" placeholder="Descrição de quem recebeu a oferta" required>
							</div>
						</div>
