...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Nova Contagem</a>
</div>
		...
		<div class="modal-content">
			...
			<form id="form" method="post">
				<div class="modal-body">
					...
					<div class="col-md-12">
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Descrição do Ofertante </label>
							<input type="text" class="form-control" id="membro" name="membro"
								placeholder="Descrição do Ofertante" required>
						</div>
					</div>
