...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="index.php"><img src="../img/igrejas/<?php echo $foto_igreja ?>" width="40px"
					height="40px"></a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>"
									href="index.php?pag=coordenadores">Coordenadores</a></li>
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>"
									href="index.php?pag=tesoureiros">Tesoureiros</a></li>
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>" href="index.php?pag=igrejas">Dados da
								Igreja</a></li>

						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>"
								href="index.php?pag=programacao">Programação</a></li>

						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>"
								href="index.php?pag=alertas">Alertas</a></li>

						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>"
								href="index.php?pag=eventos">Eventos</a></li>

						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>"
								href="index.php?pag=versiculos">Versículos</a></li>
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<li><a class="dropdown-item" href="#" data-bs-toggle="modal"
								data-bs-target="#modalRelMembros">Membros</a></li>
						...
						<li><a class="dropdown-item <?php echo $esc_secretario ?>" href="#" data-bs-toggle="modal"
								data-bs-target="#modalRelFinanceiro">Financeiros</a></li>

						<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>" href="#" data-bs-toggle="modal"
								data-bs-target="#modalRelAniversario">Aniversáriantes</a></li>
				...
				<li class="nav-item">
					<a class="nav-link" aria-current="page" href="../../apiIgreja/notific/script.php"
						target="_blank">Notificações</a>
				</li>
				...
				<div class="d-flex mx-4">
					<img class="img-profile rounded-circle" src="../img/membros/<?php echo $foto_usu ?>" width="40px"
						height="40px">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="form-usu" method="post">
					...
					<div class="row">
						<div class="col-md-8">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="nome_usu" name="nome_usu"
						...
						<div class="col-md-4">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="cpf_usu" name="cpf_usu"
									placeholder="Insira o CPF" value="<?php echo $cpf_usu ?>" required>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-8">
							<div class="mb-3">
								...
								<input type="email" class="form-control" id="email_usu" name="email_usu"
									placeholder="Insira o Email" value="<?php echo $email_usu ?>" required>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-8">
								<div class="mb-3">
									...
									<input type="file" class="form-control-file" id="imagem-usu" name="imagem"
				...
				<small>
					<div align="center" id="msg-usu"></div>
				</small>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
						id="btn-fechar-usu">Fechar</button>
					...
					<div class="row">
							...
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Data Inicial <small><small>(
											<a href="#" class="text-primary"
												onclick="datas('1980-01-01', 'tudo-pat', 'pat')">
												<span id="tudo-pat">Tudo</span>
											</a> /
											<a href="#" class="text-dark"
												onclick="datas('<?php echo $data_atual ?>', 'hoje-pat', 'pat')">
												<span id="hoje-pat">Hoje</span>
											</a> /
											<a href="#" class="text-dark"
												onclick="datas('<?php echo $data_mes ?>', 'mes-pat', 'pat')">
												<span id="mes-pat">Mês</span>
											</a> /
											<a href="#" class="text-dark"
												onclick="datas('<?php echo $data_ano ?>', 'ano-pat', 'pat')">
												<span id="ano-pat">Ano</span>
											</a>
											)</small></small></label>
								<input type="date" class="form-control form-control-sm" name="dataInicial"
									id="dtInicial-pat" value="1980-01-01">
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="mb-3">
								...
								<input type="date" class="form-control form-control-sm" name="dataFinal"
									id="dtFinal-pat" value="<?php echo $data_atual ?>">
							</div>
						</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Relatório Financeiro <small><small>(
							...
							<a href="#" class="text-dark"
								onclick="datas('<?php echo $data_atual ?>', 'hoje-fin', 'fin')">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="mb-3">
								...
								<input type="date" class="form-control form-control-sm" name="dataInicial"
									id="dtInicial-fin" value="1980-01-01">
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Data Final</label>
								<input type="date" class="form-control form-control-sm" name="dataFinal"
									id="dtFinal-fin" value="<?php echo $data_atual ?>">
							</div>
						</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Relatório Aniversáriantes <small><small>(
							...
							<a href="#" class="text-primary"
								onclick="datas('<?php echo $data_atual ?>', 'hoje-ani', 'ani')">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Data Inicial </label>
								<input type="date" class="form-control form-control-sm" name="dataInicial"
									id="dtInicial-ani" value="<?php echo $data_atual ?>">
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Data Final</label>
								<input type="date" class="form-control form-control-sm" name="dataFinal"
									id="dtFinal-ani" value="<?php echo $data_atual ?>">
							</div>
						</div>
