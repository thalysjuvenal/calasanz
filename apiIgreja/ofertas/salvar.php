...
if($id == "" || $id == 0){
	$query = $pdo->prepare("INSERT INTO ofertas SET membro = '$membro', valor = :valor, data = '$data', usuario = '$id_usuario', igreja = '$igreja'");
...
$pdo->query("INSERT INTO movimentacoes SET tipo = 'Entrada', movimento = 'Oferta', descricao = '$nome_membro', valor = '$valor', data = '$data', usuario = '$id_usuario', id_mov = '$ult_id', igreja = '$igreja'");
	...
	$query = $pdo->prepare("UPDATE ofertas SET membro = '$membro', valor = :valor, data = '$data', usuario = '$id_usuario', igreja = '$igreja' where id = '$id'");
