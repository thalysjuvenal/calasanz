...
$query = $pdo->prepare("SELECT * FROM pagar where (vencimento BETWEEN '$data' and '$data1') and igreja = '$id_igreja' and pago LIKE '$pago' ORDER BY vencimento ASC, pago asc, id asc");
